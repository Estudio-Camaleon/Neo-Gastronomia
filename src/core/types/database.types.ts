  ...
  public: {
    Tables: {
      ...
      producto_opciones_grupos: {
        ...
        Relationships: [
          {
            foreignKeyName: "producto_opciones_grupos_producto_id_fkey";
            columns: ["producto_id"];
            isOneToOne: false;
            referencedRelation: "productos";
            referencedColumns: ["id"];
      ...
      producto_opciones_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "producto_opciones_items_grupo_id_fkey";
            columns: ["grupo_id"];
            isOneToOne: false;
            referencedRelation: "producto_opciones_grupos";
            referencedColumns: ["id"];
          },
        ];
      };
