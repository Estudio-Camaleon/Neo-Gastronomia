  ...
  return (
    <div className="w-full min-h-screen bg-[var(--color-custom-surface)] flex flex-col items-center justify-center p-6 text-center font-sans">
      ...
      <p className="text-[var(--color-custom-text-muted)] max-w-sm mb-8 text-[14px] leading-relaxed">
        Tuvimos un problema de conexion al cargar el menu de este local. Por
        favor, intenta de nuevo.
      </p>

      <button
        onClick={() => reset()}
        className="flex items-center gap-2 bg-[var(--color-custom-900)] text-white px-6 py-2.5 rounded-full text-[13px] font-semibold hover:opacity-90 active:scale-95 transition-all shadow-md"
      >
