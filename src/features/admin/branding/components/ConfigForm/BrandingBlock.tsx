...
import { Camera, ImageIcon, Upload, MapPin, Clock, MessageCircle, XCircle, ArrowUp, ArrowDown, Minus, Smartphone, X } from "lucide-react";
...
export function BrandingBlock({
  ...
  const socialPriority = [
    ...
    { id: "instagram", url: instagram_url },
    { id: "facebook", url: facebook_url },
    { id: "tiktok", url: tiktok_url },
    { id: "twitter", url: twitter_url },
    { id: "youtube", url: youtube_url },
  ].filter((s) => s.url);

  const topSocialIds = socialPriority.slice(0, 3).map((s) => s.id);
            ...
            >
              ...
              {hasSocials && (
                <div className="flex flex-wrap justify-center gap-2 mt-3">
                  ...
                  {topSocialIds.includes("facebook") && (
                    <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80">
  ...
  return (
    <div className="bg-[var(--admin-surface)] border border-[var(--admin-border)] rounded-xl overflow-hidden shadow-sm">
      <div className="px-5 py-3.5 border-b border-[var(--admin-border)] bg-[var(--admin-bg)]/50 flex items-center gap-2.5">
        ...
        <div>
          ...
          <p className="text-[10px] text-[var(--admin-text-muted)]">
            Vista aproximada de cómo se verá el encabezado en el menú público.
          </p>
        </div>
      </div>
      ...
      <div className="md:hidden">
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <span className="text-[11px] font-semibold text-[var(--admin-text)] block">
              Tocá para previsualizar
            </span>
            <span className="text-[10px] text-[var(--admin-text-muted)] block truncate">
              {nombre || "Nombre del negocio"}
            </span>
          </div>
      ...
      {/* Mobile/Tablet: modal with phone mockup */}
      {previewOpen && (
        <div
                ...
                <div className="relative w-full" style={{ aspectRatio: "1/1", minHeight: "300px" }}>
                  ...
                  <div className="absolute inset-0 flex items-center justify-center px-5">
                    <div className="relative w-[220px]">
                        ...
                        >
                          {logoUrl ? (
                            <img
                              ...
                              className={
                                isSticker
                                  ? "max-h-28 max-w-28 drop-shadow-2xl"
                                  : "h-full w-full object-cover"
                              }
                              style={isSticker ? logoStyle : { ...logoStyle, objectFit: "cover" }}
                            />
                          ) : (
                            <div
                              className={
                      ...
                      <div
                        className="backdrop-blur-xl rounded-[22px] shadow-2xl pt-[56px] pb-5 px-4"
                        style={{
                          backgroundColor: "color-mix(in srgb, " + cardBgStyle + ", transparent 15%)",
                        }}
                      >
                        {mostrarNombre && (
                          <h1 className="text-center text-white text-lg font-extrabold leading-tight tracking-tight">
                            {nombre || "Nombre del negocio"}
                          </h1>
                        )}

                        {descripcion && (
                          <p className="text-center text-white/70 text-[11px] mt-1 max-w-[500px] mx-auto leading-relaxed">
                            {descripcion}
                          </p>
                        )}
                        ...
                        <div className="flex justify-center gap-2 mt-2.5">
                          <div className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-white/10 text-white/80 text-[9px]">
                            <MapPin size={11} />
              ...
              <div className="flex gap-1">
                {LOGO_SHAPE_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`flex items-center justify-center gap-1.5 flex-1 px-2 py-1.5 text-[10px] font-medium rounded-md transition-all ${
                      logoShape === opt.value
              ...
              <div className="flex gap-1">
                {LOGO_POSITION_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`flex items-center justify-center gap-1 flex-1 px-2 py-1.5 text-[10px] font-medium rounded-md transition-all ${
        ...
        <div className="md:col-span-7 flex flex-col space-y-3">
              ...
              <div className="flex gap-1">
                {BANNER_VERTICAL_OPTIONS.map((opt) => (
                  <button
                    ...
                    className={`flex items-center justify-center gap-1 px-2.5 py-1.5 text-[10px] font-medium rounded-md transition-all ${
          ...
          <div className="space-y-1 pt-1">
            ...
            <div className="flex items-center gap-2">
              <span className="text-[9px] text-[var(--admin-text-muted)]/60 font-mono">0.5x</span>
              <input
                type="range"
                min="0.5"
                max="2"
              ...
              />
              <span className="text-[9px] text-[var(--admin-text-muted)]/60 font-mono">2x</span>
            </div>
          </div>
